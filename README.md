...
![GitHub forks](https://img.shields.io/github/forks/Himanshu-133/ERP-Managment-System?style=social)
...
```bash
git clone https://github.com/Himanshu-133/ERP-Managment-System.git
2️⃣ Navigate into the Project
cd ERP-Managment-System
3️⃣ Run the Project
...
4️⃣ Configure Database (If Backend Enabled)
